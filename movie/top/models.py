...
class Movie(models.Model):
    ...
    directors = models.CharField(u"电影导演", max_length=20, null=True, blank=True)
    casts = models.CharField(u"电影演员", max_length=20, null=True, blank=True)
    images = models.CharField(u"电影海报", max_length=50, null=True, blank=True)
